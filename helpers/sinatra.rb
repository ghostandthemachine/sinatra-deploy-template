helpers do
  ...
  def main_haml(template, options={})
    haml(template, options.merge(layout: :'main/layout'))
  end

  def music_haml(template, options={})
    haml(template, options.merge(layout: :'music/layout'))
  end
end